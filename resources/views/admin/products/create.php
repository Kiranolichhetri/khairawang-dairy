            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select id="status" name="status" required 
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-orange">
                        <option value="published" <?= $view->old('status', 'published') === 'published' ? 'selected' : '' ?>>Published</option>
                        <option value="draft" <?= $view->old('status') === 'draft' ? 'selected' : '' ?>>Draft</option>
                        <option value="archived" <?= $view->old('status') === 'archived' ? 'selected' : '' ?>>Archived</option>
                    </select>
                </div>
                
                <div class="flex items-center pt-6">
                    <input type="checkbox" id="featured" name="featured" value="1"
                           <?= $view->old('featured') ? 'checked' : '' ?>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" id="seo_title" name="seo_title"
                           value="<?= $view->e($view->old('seo_title')) ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-orange">
                </div>
                ...
                <div>
                    ...
                    <textarea id="seo_description" name="seo_description" rows="2"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-orange"><?= $view->e($view->old('seo_description')) ?></textarea>
                </div>
            </div>
        </div>
...
(function() {
    ...
    // Initialize with existing images (from old input if validation failed)
    let uploadedImages = [];
    try {
