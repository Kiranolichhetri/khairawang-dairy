...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-2xl font-heading font-bold text-dark-brown">Add New Address</h1>
    </div>

    <!-- Address Form -->
    <form action="/account/addresses" method="POST" class="bg-white rounded-xl shadow-sm p-6 space-y-6">
        <?= $view->csrf() ?>
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select id="label" 
                    ...
                    <?php foreach ($labels as $label): ?>
                        <option value="<?= $view->e($label) ?>" <?= $view->old('label') === $label ? 'selected' : '' ?>>
                            <?= $view->e($label) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div>
                ...
                <select id="address_type" 
                    ...
                    <?php foreach ($types as $value => $typeLabel): ?>
                        <option value="<?= $view->e($value) ?>" <?= $view->old('address_type', 'both') === $value ? 'selected' : '' ?>>
                            <?= $view->e($typeLabel) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div>
                ...
                <input type="text" 
                       id="full_name" 
                       name="full_name" 
                       value="<?= $view->e($view->old('full_name')) ?>"
                       required
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" 
                       id="address_line_1" 
                       name="address_line_1" 
                       value="<?= $view->e($view->old('address_line_1')) ?>"
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" 
                       id="address_line_2" 
                       name="address_line_2" 
                       value="<?= $view->e($view->old('address_line_2')) ?>"
            ...
            <div>
                ...
                <select id="district" 
                    ...
                    <?php foreach ($districts as $district): ?>
                        <option value="<?= $view->e($district) ?>" <?= $view->old('district') === $district ? 'selected' : '' ?>>
                            <?= $view->e($district) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div>
                ...
                <input type="text" 
                       id="postal_code" 
                       name="postal_code" 
                       value="<?= $view->e($view->old('postal_code')) ?>"
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-orange focus:border-transparent">
            </div>
